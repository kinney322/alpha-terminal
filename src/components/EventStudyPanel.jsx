...
const EVENT_STUDY_COPY = {
  en: {
    ...
    sentimentPending: 'Waiting',
    sentimentBeat: 'Beat',
    sentimentMiss: 'Miss',
    sentimentInline: 'Inline',
    ready: 'Ready',
    pending: 'Waiting',
    pendingData: 'Waiting for prices',
    excluded: 'Excluded',
    ...
    confidencePending: 'Waiting for data',
...
function normalizeEarningsGapSummaryPayload(payload, displayTicker = null, sampleFilter = DEFAULT_SAMPLE_FILTER) {
  ...
  return {
    ...
    details: rows.map((row) => ({
      ...
      sentiment: row.gap_return > 0 ? 'Gap Up' : row.gap_return < 0 ? 'Gap Down' : 'Waiting',
