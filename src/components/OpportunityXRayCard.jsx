      ...
      <div className="xray-card__grid">
        <section className="xray-engine">
          ...
          <div className="xray-insight-list">
            ...
            <InsightRow label="Win Long" value={formatPercent(row.winLong == null ? null : row.winLong * 100, 0)} tone="positive" />
            <InsightRow label="Win Short" value={formatPercent(row.winShort == null ? null : row.winShort * 100, 0)} tone="negative" />
          </div>
        </section>
